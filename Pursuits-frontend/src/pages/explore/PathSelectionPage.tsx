  ...
  const milestones = [
    {
      ...
      description:
        "Explore competitive exams for public sector roles, defense, and administrative services.",
      icon: Building2,
    ...
    },
    {
      ...
      description:
        "Discover specialized, skill-based professional diplomas for rapid industry entry.",
      icon: Award,
    ...
    },
    {
      ...
      description:
        "Browse comprehensive degree courses like B.Tech, B.Sc, and other undergraduate programs.",
      icon: BookOpen,
        ...
        <main className="flex-1 min-w-0 pb-20 w-full">
          ...
          <div className="mb-12">
            ...
            <p
              ...
              style={{ fontFamily: "Plus Jakarta Sans, sans-serif" }}
            >
              You've selected the {streamName} stream. Explore the three main
              avenues available to you and discover which aligns best with your
              career aspirations.
            </p>
          </div>
            ...
            {milestones.map((milestone) => (
              ...
              >
                <div className="bg-surface-container-lowest rounded-2xl p-8 border border-outline-variant/20 hover:border-[#3DC6E7]/30 hover:shadow-card-hover transition-all duration-300 h-full flex flex-col relative overflow-hidden">
                  <div
                    className={`w-14 h-14 rounded-xl ${milestone.iconBg} flex items-center justify-center mb-6 relative z-10`}
                  >
                    <milestone.icon
                      className={milestone.iconColor}
                      size={28}
                      strokeWidth={2}
                    />
                  </div>
                  <h3
                    className="text-xl font-bold text-on-surface mb-3 relative z-10"
                    style={{ fontFamily: "Plus Jakarta Sans, sans-serif" }}
                  >
                    {milestone.title}
                  </h3>
                  <p
                    className="text-body-md text-on-surface-variant leading-relaxed mb-6 flex-grow relative z-10"
                    style={{ fontFamily: "Plus Jakarta Sans, sans-serif" }}
                  >
