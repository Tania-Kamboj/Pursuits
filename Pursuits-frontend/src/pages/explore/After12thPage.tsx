...
export const After12thDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      {/* Main Layout */}
      <div className="flex max-w-[1400px] mx-auto px-4 lg:px-6 py-6 lg:py-10 gap-6 lg:gap-10 w-full min-h-[calc(100vh-72px)]">
        
        {/* Desktop Sidebar */}
        <aside className="hidden lg:block w-64 flex-shrink-0 sticky top-[90px] h-[calc(100vh-140px)] self-start">
        ...
        <main className="flex-1 min-w-0 pb-20 w-full">
          {/* Breadcrumbs */}
          <div className="flex items-center justify-between mb-6 lg:mb-8 sticky top-[72px] lg:top-[90px] z-40 backdrop-blur-md py-3 lg:py-4 -mx-4 lg:mx-0 px-4 lg:px-0">
            <div className="flex items-center gap-2 text-body-md text-on-surface-variant text-sm lg:text-base">
              <Link
                to="/"
          ...
          <div className="mb-8 lg:mb-12 max-w-3xl">
            <h1
              className="text-3xl lg:text-4xl font-bold text-on-surface mb-3 lg:mb-4 tracking-tight"
              style={{ fontFamily: "Plus Jakarta Sans, sans-serif" }}
            >
              Which stream did you study till 12th?
            </h1>
            <p
              className="text-base lg:text-lg text-on-surface-variant leading-relaxed"
              style={{ fontFamily: "Plus Jakarta Sans, sans-serif" }}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 lg:gap-6">
            {streams.map((stream) => (
              <Link
                ...
                className="group flex flex-col items-center text-center p-5 lg:p-6 bg-surface-container-lowest rounded-3xl border border-outline-variant/20 hover:shadow-card-hover hover:border-[#3DC6E7]/30 hover:-translate-y-1 transition-all duration-300"
              >
