...
export const Footer = () => (
  <footer className="bg-cool-platinum mt-auto">
    <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="space-y-4">
        <Link to="/" className="text-[24px] text-[#3DC6E7]">Pursuits</Link>
        <p className="text-on-surface-variant max-w-xs text-sm">
          Helping students make better decisions about their education and career, aligned with their interests with Pursuits.
        </p>
      </div>
  ...
  <ul className="space-y-3 text-sm">
    ...
    <div className="py-6 text-center text-label text-text-muted text-xs">
      © {new Date().getFullYear()} Pursuits. All rights reserved. Tania 💙
    </div>
  </footer>
)