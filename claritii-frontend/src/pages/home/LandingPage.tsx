    ...
    >
      ...
      <section className="relative w-full px-6 lg:px-12 py-20">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center space-y-8">
          ...
          >
            Explore the best roadmap to your passion. Turn what you love into a future you'll love with Claritii.
          </p>
...
//                 }}
//               >
//                 Claritii has everything you need to know about where your
