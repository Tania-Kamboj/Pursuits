        ...
        <div className="grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-surface-container-lowest rounded-2xl p-6 border border-outline-variant/20">
              ...
              <a 
                href={`mailto:reachlevelzenith@gmail.com?subject=Claritii Inquiry&body=Hi Claritii Team,%0D%0A%0D%0AI would like to know about...%0D%0A%0D%0AThanks`}
                className="text-[#3DC6E7] font-medium hover:underline flex items-center gap-1"
              >
                support@claritii.com <ArrowRight size={16} />
              </a>
            </div>
            ...
            <div className="bg-surface-container-lowest rounded-2xl p-6 border border-outline-variant/20">
              ...
              <p className="text-body-md text-on-surface-variant">
                We are a small team working hard to build Claritii. We usually get back to you within 1 to 2 working days.
              </p>
            </div>
          </div>
